package com.example.android.filter.utility;
import android.content.Context;
import android.graphics.Bitmap;
import android.os.Environment;

import com.example.android.filter.R;
...
public class Helper {
    public static boolean writeDataIntoExternalStorage(Context context, String fileName, Bitmap bitmap) {
        ...
        public static File getFileFromExternalStorage (Context context, String filename){
            File directory = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + R.string.app_name);
            File file = new File(directory.getAbsolutePath() + "/" + filename);
